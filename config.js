...
module.exports = {
    ...
    SESSION: process.env.ACHUMWOL_CODE === undefined ? '' : process.env.ACHUMWOL_CODE,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'ABHIRAM SACHU' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝐑𝐃𝐗' : process.env.BOT_NAME,
